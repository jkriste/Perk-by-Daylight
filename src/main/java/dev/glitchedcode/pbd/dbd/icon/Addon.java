...
public enum Addon implements Icon {
    ...
    ETHER10("ether10", "Ether 10%", "Guam", CLOWN),
    ETHER15("ether15", "Ether 15%", "Guam", CLOWN),
    ETHER5("ether5", "Ether 5%", "Guam", CLOWN),
    ...
    LEOPARD_PRINT_FABRIC("leopardPrintFabric", "Leopard Print Fabric", "Wales", EXECUTIONER),
    ...
    APEX_MUFFLER("apexMuffler", "Apex Muffler", "Xipre", HILLBILLY),
    BIG_BUCKLE("bigBuckle", "Big Buckle", "Xipre", HILLBILLY),
    BLACK_GREASE("blackGrease", "Black Grease", "Xipre", HILLBILLY),
    DADS_BOOTS("dadsBoots", "Dads Boots", "Xipre", HILLBILLY),
    DEATH_ENGRAVINGS("deathEngravings", "Death Engravings", "Xipre", HILLBILLY),
    DOOM_ENGRAVINGS("doomEngravings", "Doom Engravings", "Xipre", HILLBILLY),
    HEAVY_CLUTCH("heavyClutch", "Heavy Clutch", "Xipre", HILLBILLY),
    IRIDESCENT_BRICK("iridescentBrick", "Iridescent Brick", "Xipre", HILLBILLY),
    JUNKYARD_AIR_FILTER("junkyardAirFilter", "Junkyard Air Filter", "Xipre", HILLBILLY),
    LEAFY_MASH("leafyMash", "Leafy Mash", "Xipre", HILLBILLY),
    LOW_KICKBACK_CHAINS("lowKickbackChains", "Low Kickback Chains", "Xipre", HILLBILLY),
    LOW_PRO_CHAINS("lowProChains", "Low Pro Chains", "Xipre", HILLBILLY),
    MOTHERS_HELPERS("mothersHelpers", "Mothers Helpers", "Xipre", HILLBILLY),
    OFF_BRAND_MOTOR_OIL("offBrandMotorOil", "Off Brand Motor Oil", "Xipre", HILLBILLY),
    PIGHOUSE_GLOVES("pighouseGloves", "Pighouse Gloves", "Xipre", HILLBILLY),
    PUNCTURED_MUFFLER("puncturedMuffler", "Punctured Muffler", "Xipre", HILLBILLY),
    SPEED_LIMITER("speedLimiter", "Speed Limiter", "Xipre", HILLBILLY),
    SPIKED_BOOTS("spikedBoots", "Spiked Boots", "Xipre", HILLBILLY),
    STEEL_TOE_BOOTS("steelToeBoots", "Steel Toe Boots", "Xipre", HILLBILLY),
    TUNED_CARBURETOR("tunedCarburetor", "Tuned Carburetor", "Xipre", HILLBILLY);
